...
namespace Kasznar.Application.Tests.Services
{
    public class UserServiceTests
    {
        ...
        {
            var result = userService.Post(new UserViewModel { Name = "Adriana Borges", Email = "nicolas.rfontes@gmail.com" });
            Assert.True(result);
        }
        ...
        public void Get_ValidatingObject()
        {
            ...
            _users.Add(new User { Id = Guid.NewGuid(), Name = "Adriana Borges", Email = "drika.fonseca.borges@gmail.com", DateCreated = DateTime.Now });
        ...
        {
            var exception = Assert.Throws<ValidationException>(() => userService.Post(new UserViewModel { Name = "Adriana Borges" }));
